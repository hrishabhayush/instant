...
function captureInstagramReelFrame(targetElementId: any) {
    try {
        ...
        if (targetElementId) {
            ...
            if (clickedElement) {
                ...
                video = clickedElement.querySelector('video[playsinline]') as HTMLVideoElement || 
                       clickedElement.closest('video[playsinline]') as HTMLVideoElement ||
                       clickedElement.parentElement?.querySelector('video[playsinline]') as HTMLVideoElement
            }
        }
        ...
        if (!video) {
            ...
            video = document.querySelector('video[playsinline]') as HTMLVideoElement
        }
...
function findMostVisibleVideo(): HTMLVideoElement | null {
    ...
    videos.forEach(video => {
        ...
        if (visibility > maxVisibility) {
            ...
            mostVisible = video as HTMLVideoElement
        }
    })
...
function calculateVisibility(rect: DOMRect): number {
...
function isElementVisible(element: HTMLVideoElement): boolean {
